...
const NavigationBar = ({ activeItem = 'asset' }: NavigationBarProps) => {
  return (
    <div className="navigation-bar">
      <div className="nav-placeholder">
        <div className={`nav-item ${activeItem === 'home' ? 'active' : ''}`}>
        ...
        <div className={`nav-item ${activeItem === 'asset' ? 'active' : ''}`}>
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <div className={`nav-item ${activeItem === 'plan' ? 'active' : ''}`}>
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <div className={`nav-item ${activeItem === 'settings' ? 'active' : ''}`}>
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
